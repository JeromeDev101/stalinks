...
class AlterBuyerValidGraphStoredProcThree extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    {
        $procedure =
            'CREATE PROCEDURE `buyer_valid_graph`(
        ...
        \Illuminate\Support\Facades\DB::unprepared('DROP procedure IF EXISTS buyer_valid_graph');
