export default {
    ...
    h1 : 'Validasi Penulis',
    p1: 'Sebelum Anda dapat mulai menulis artikel, Anda perlu membuktikan kemampuan menulis Anda dengan menjawab ujian penulis kami.',
    ol1 : 'Anda akan diberi tahu melalui email dan notifikasi sistem setelah ujian Anda siap. Untuk memeriksanya, navigasikan ke halaman \'Validasi Penulis\'. Ikuti instruksi yang terletak di bagian atas halaman dengan hati-hati. Anda akan diberikan dua upaya untuk lulus ujian.',
    ol2 : 'Masukkan detail yang diperlukan seperti judul, deskripsi meta, dan yang terpenting, konten. Setelah selesai, klik tombol kirim di bawah.',
    ol3 : 'Anda akan diberitahu tentang hasil ujian Anda melalui email dan notifikasi sistem. Jika Anda gagal dalam percobaan pertama, Anda akan diberikan ujian percobaan kedua setelah 3 hari. Jika Anda telah lulus ujian, Anda sekarang dapat mulai menulis artikel. Selamat',
