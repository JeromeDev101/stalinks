export default {
    ...
    h1 : 'Writer Validation',
    p1: 'Before you can start writing articles, you need to prove your writing skills by answering our writer examination.',
    ol1 : 'You will be notified via email and system notification once your exam is ready. To check this, navigate to the ‘Writer’s Validation’ page. Follow the instructions located at the top part of the page carefully. You will be given two attempts to pass the exam.',
    ol2 : 'Input the required details like the title, meta description and most importantly, the content. Once you are done, click the submit button down below.',
    ol3 : 'You will be notified about the results of your exam via email and system notification. If you have failed your first attempt, you will be given a second attempt exam after 3 days. If you have passed the exam, you can now start writing article. Congratulations',
