export default {
    ...
    b2 : {
        text : 'How To Add Credits To Your Account',
    ...
    b5 : {
        text : 'Learn how to add your URLs',
    ...
    b8 : {
        text : 'Learn How to Navigate the Dashboard',
        url : '/help/writer-guide-1'
    },
    b9 : {
        text : 'Learn About Writer Validation',
        url : '/help/writer-guide-2'
    },
    b99 : {
        text : 'Learn About Writing Quality Content',
