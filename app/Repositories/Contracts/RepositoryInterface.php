...
interface RepositoryInterface
{
    ...
    /**
     * create new record or find existing record
     *
     * @param  array $attributes
     *
     * @return Model
    ...
    /**
     * Find  data pagination with page, per_page, filter, and select column
     *
     * @param integer $page number of pagination
     * @param integer $perPage total data per page of pagination
     * @param array $filters filter of data
     * @param array $column select column
